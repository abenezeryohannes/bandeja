                    ...
                    <div class="row">
                        <template v-for="f in fields">                        
                            ...
                            <template v-else-if="f.type == 'switcher'">
                                <ak-switcher v-model="models[f.name]" multiple="true" :label="f.label" :options="f.options" :default="f.default" />
                            </template>                        
                ...
                <div class="card-footer">
                    <div class="row save-buttons">
                        <div class="col-md-12">
                            ...
                            <button v-on:click="save" class="btn btn-icon btn-success button-submit header-button-top">
...
<script>
export default {
    props: ["boot_api","boot_data", "action_api","method","return_url"],
    data() {
        return {
