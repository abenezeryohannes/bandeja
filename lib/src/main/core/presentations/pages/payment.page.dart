...
class PaymentPage extends StatefulWidget {
  const PaymentPage({Key? key, required this.order, required this.padel})
      : super(key: key);
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  @override
  void initState() {
    _controller = PaymentController(order: widget.order, padel: widget.padel);
    super.initState();
  }
