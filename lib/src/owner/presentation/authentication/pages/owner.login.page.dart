...
import 'package:bandeja/src/owner/presentation/authentication/controllers/owner.login.page.controller.dart';
...
class _OwnerLoginPageState extends State<OwnerLoginPage> {
  final controller = Get.put(OwnerLoginPageController());
  @override
